package galaxy
{
	...
	public class LVD_06008 extends Scene3DTemplateForASProject
	{
...
//			trace("show: ", instruction);
		...
		private function initTextSequence():void
		{
			...
			switch (language)
			{
				case "zh_CN" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 82, "text": "1.按下侧边卡扣，打开电箱", "inverseText": "4.盖上电箱，按上卡扣"}, 
						{"startFrame": 104, "stopFrame": 308, "text": "2.拧下灯罩螺丝，卸下灯罩，玻璃，皮圈", "inverseText": "3.安装玻璃，皮圈，灯罩，拧上螺丝"}, 
						{"startFrame": 332, "stopFrame": 368, "text": "3.拧下灯罩支架螺丝，取下灯管支架", "inverseText": "2.安装灯管支架，拧上螺丝"}, 
						{"startFrame": 392, "stopFrame": 476, "text": "4.拧下螺丝,取出镇流器", "inverseText": "1.安装镇流器，拧上螺丝"}
					);
					break;
				case "en_US" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 82, "text": "1.Tighten side buckle and open electrical box", "inverseText": "4.Close electrical box and then tighten buckle"}, 
						{"startFrame": 104, "stopFrame": 308, "text": "2.Unscrew shade screws and then remove shade, glass and apron", "inverseText": "3.Install glass, apron, shade, and then tighten screws"}, 
						{"startFrame": 332, "stopFrame": 368, "text": "3.Remove shade bracket screws and remove lamp and bracket", "inverseText": "2.Mount lamp and bracket, and then tighten screws"}, 
						{"startFrame": 392, "stopFrame": 476, "text": "4.Unscrew screws and then remove ballast", "inverseText": "1.Install ballast and then tighten screws"}
					);
					break;
				case "ja_JP" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 82, "text": "1.横のファスナーを開いて、電器箱を開く。", "inverseText": "4.電器箱を蓋をして、ファスナーを押す。"}, 
						{"startFrame": 104, "stopFrame": 308, "text": "2.ランプかさネジを緩めて、ランプかさ、ガラス、ゴムを取り外す。", "inverseText": "3.ガラス、ゴム、ランプかさを取り付けて、ネジを締める。"}, 
						{"startFrame": 332, "stopFrame": 368, "text": "3.ランプ傘のスタンドのネジを緩めて、灯管ブラケットを取り外す。", "inverseText": "2.灯管ブラケットを取り付けて、ネジを締める。"}, 
						{"startFrame": 392, "stopFrame": 476, "text": "4.ネジを緩めて、バラストを取り出す。", "inverseText": "1.バラストを取り付けて、ネジを締める。"}
					);
					break;
				case "ko_KR" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 82, "text": "1.옆 단춧구멍을 풀이고 전함을 열리다", "inverseText": "4.전함 덮개를 닫고 단춧구멍을 채우다"}, 
						{"startFrame": 104, "stopFrame": 308, "text": "2.등갓 나사를 빼내고 등갓,유리,고무 튜브를 떼다", "inverseText": "3.유리，고무 튜브，등갓를 설치하고 나사를 조인다"}, 
						{"startFrame": 332, "stopFrame": 368, "text": "3.등갓,스탠드,나사를 빼내고 등관,스탠드를 꺼내다", "inverseText": "2.스탠드와 등관을 설치하고 나사를 조인다"}, 
						{"startFrame": 392, "stopFrame": 476, "text": "4.나사를 빼내고 안정기를 꺼내다", "inverseText": "1.안정기를 설치하고 나사를 조인다"}
					);
					break;
				case "fr_FR" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 82, "text": "1.Pressez sur le composant enfichable de côté, ouvrez la boîte électrique ", "inverseText": "4.Fermez la boîte électrique, pressez sur le composant enfichable"}, 
						{"startFrame": 104, "stopFrame": 308, "text": "2.Dévissez les vis de l’abat-jour, enlevez l'ombre, le verre, le tablier", "inverseText": "3.Installez le verre, l’anneau en cuir embouti , l’abat-jour, et serrez les vis "}, 
						{"startFrame": 332, "stopFrame": 368, "text": "3.Retirez les vis du support de l'ombre, retirez le support de la lampe", "inverseText": "2.Installez le support de lampe et serrez les vis"}, 
						{"startFrame": 392, "stopFrame": 476, "text": "4.Dévissez et enlevez le ballast", "inverseText": "1.Installez ballast, serrez les vis"}
					);
					break;
				case "ru_RU" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 82, "text": "1.Снимите пряжку и откройте электрическии блок", "inverseText": "4.Покрывает крышку электрического блока,установите и пряжку"}, 
						{"startFrame": 104, "stopFrame": 308, "text": "2.Отверните винт абажура, снимите абажур, стекло, ремешок", "inverseText": "3.Установите стекло, ремешок, абажур, ввинтите винт"}, 
						{"startFrame": 332, "stopFrame": 368, "text": "3.Отверните винт кронштейна, снимите кронштейн и трубку", "inverseText": "2.Установите кронштейн и трубку, ввинтите винт"}, 
						{"startFrame": 392, "stopFrame": 476, "text": "4.Отверните винт, принимает вне балласт", "inverseText": "1.Установите балласт, ввинтите винт"}
					);
					break;
				case "ar_SA" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 82, "text": " 1انقر الرز على الجانب و فتح المربع الكهربائي", "inverseText": "4تركيب غطاء المربع الكهربائي وتشديد المسامير الأربعة"}, 
						{"startFrame": 104, "stopFrame": 308, "text": "2فك مسامير الغطاء وإزالة الغطاء و الزجاج و الحزام", "inverseText": " 3تثبيت الزجاج و الغطاء مع تشديد الرز"}, 
						{"startFrame": 332, "stopFrame": 368, "text": " 3فك مسامير الفرع  وإزالة الفرع  و  أخذ فرع المصباح", "inverseText": " 2تثبيت فرع المصباح، و تشديد المسامير"}, 
						{"startFrame": 392, "stopFrame": 476, "text": "4فك المسمار وإزالة الكابح", "inverseText": " 1تثبيت الكابح وتشديد المسامير"}
					);
					break;
				case "es_ES" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 82, "text": "1.Abierta la hebilla lateral y abierta la caja eléctrica.", "inverseText": "4.cierre la tapa de la caja eléctrica, apretar la hebilla"}, 
						{"startFrame": 104, "stopFrame": 308, "text": "2.Afloje los tornillos de pantalla y luego retire la pantalla , el vidrio y la goma.", "inverseText": "3.Instale el vidrio, el goma, la pantalla, apriete los tornillos."}, 
						{"startFrame": 332, "stopFrame": 368, "text": "3.Afloje los tornillos de soporte, retire la lámpara y soporte.", "inverseText": "2.Monte el soporte, Apriete los tornillos"}, 
						{"startFrame": 392, "stopFrame": 476, "text": "4.Afloje los tornillos,retire el balastro", "inverseText": "1.Instale balastro, Apriete los tornillos"}
					);
					break;
			}
		...
		private function initInstruction():void
		{
			...
			{
				case "zh_CN" :
					instructionDict["bolin"] = "玻璃";
					instructionDict["dengguan"] = "灯管";
					instructionDict["dengzao"] = "灯罩";
					instructionDict["luosi"] = "螺丝";
					instructionDict["piquan"] = "皮圈";
					instructionDict["zhijia"] = "支架";
					instructionDict["zhijialuosi"] = "支架螺丝";
					instructionDict["zhenliuqi"] = "镇流器";//Ballast
					instructionDict["dianxianggai"] = "电箱盖";//Electrical box cover
					break;
				case "en_US" :
					instructionDict["bolin"] = "Glass";
					instructionDict["dengguan"] = "Lamp";
					instructionDict["dengzao"] = "Shade";
					instructionDict["luosi"] = "Screw";
					instructionDict["piquan"] = "Apron";
					instructionDict["zhijia"] = "Bracket";
					instructionDict["zhijialuosi"] = "Bracket screw";
					instructionDict["zhenliuqi"] = "Ballast";
					instructionDict["dianxianggai"] = "Electrical box cover";
					break;
				case "ja_JP" :
					instructionDict["bolin"] = "ガラスパネル";
					instructionDict["dengguan"] = "灯管";
					instructionDict["dengzao"] = "ランプカバー";
					instructionDict["luosi"] = "ネジ";
					instructionDict["piquan"] = "ゴム";
					instructionDict["zhijia"] = "スタンド";
					instructionDict["zhijialuosi"] = "スタンドネジ";
					instructionDict["zhenliuqi"] = "バラスト";
					instructionDict["dianxianggai"] = "電器箱カバー";
					break;
				case "ko_KR" :
					instructionDict["bolin"] = "유리패널";
					instructionDict["dengguan"] = "등관";
					instructionDict["dengzao"] = "등갓";
					instructionDict["luosi"] = "나사";
					instructionDict["piquan"] = "고무 튜브";
					instructionDict["zhijia"] = "스탠드";
					instructionDict["zhijialuosi"] = "스텐트 나사";
					instructionDict["zhenliuqi"] = "안정기";
					instructionDict["dianxianggai"] = "전함 덮개";
					break;
				case "fr_FR" :
					instructionDict["bolin"] = "Panneaux de verre";
					instructionDict["dengguan"] = "Tube";
					instructionDict["dengzao"] = "Abat-jour";
					instructionDict["luosi"] = "vis";
					instructionDict["piquan"] = "Tablier";
					instructionDict["zhijia"] = "Support";
					instructionDict["zhijialuosi"] = "vis du support";
					instructionDict["zhenliuqi"] = "Ballast";
					instructionDict["dianxianggai"] = "Couvercle de la boîte électrique";
					break;
				case "ru_RU" :
					instructionDict["bolin"] = "панели стекла";
					instructionDict["dengguan"] = "трубка";
					instructionDict["dengzao"] = "абажура";
					instructionDict["luosi"] = "винты";
					instructionDict["piquan"] = "ремешок";
					instructionDict["zhijia"] = "кронштейн";
					instructionDict["zhijialuosi"] = "винты кронштейна";
					instructionDict["zhenliuqi"] = "балласт";
					instructionDict["dianxianggai"] = "крышка электрического блока";
					break;
				case "ar_SA" :
					instructionDict["bolin"] = "لوحة زجاجية";
					instructionDict["dengguan"] = "انبوبة المصباح";
					instructionDict["dengzao"] = "الظل";
					instructionDict["luosi"] = "مسمار";
					instructionDict["piquan"] = "مآزر";
					instructionDict["zhijia"] = "الإطار";
					instructionDict["zhijialuosi"] = "مسمار فرع";
					instructionDict["zhenliuqi"] = "الكوابح";
					instructionDict["dianxianggai"] = "غطاء المربع الكهربائي";
					break;
				case "es_ES" :
					instructionDict["bolin"] = "Vidrio";
					instructionDict["dengguan"] = "la lámpara";
					instructionDict["dengzao"] = "la pantalla";
					instructionDict["luosi"] = "tornillo";
					instructionDict["piquan"] = "la goma";
					instructionDict["zhijia"] = "el soporte";
					instructionDict["zhijialuosi"] = "tornillo del soporte";
					instructionDict["zhenliuqi"] = "El balastro";
					instructionDict["dianxianggai"] = "la tapa de la caja eléctrica";
					break;
			}
			hasInstruction = true;
		}
