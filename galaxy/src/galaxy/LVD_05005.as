package galaxy
{
	...
	public class LVD_05005 extends Scene3DTemplateForASProject
	{
...
//			trace("show: ", instruction);
		...
		private function initTextSequence():void
		{
			switch (language)
			{
				case "zh_CN" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 116, "text": "1.拧下4个螺丝，打开电箱，取下电箱盖", "inverseText": "4.盖上电箱盖，拧上4个螺丝"}, 
						{"startFrame": 140, "stopFrame": 212, "text": "2.按下卡扣，卸下玻璃面板", "inverseText": "3.安装玻璃，按紧卡扣"}, 
						{"startFrame": 236, "stopFrame": 308, "text": "3.拧下支架螺丝，拆卸支架，拿出灯管，注意电线", "inverseText": "2.安装灯管支架，拧上螺丝"}, 
						{"startFrame": 332, "stopFrame": 416, "text": "4.拧下螺丝,取出镇流器", "inverseText": "1.安装镇流器，拧上螺丝"}
					);
					break;
				case "en_US" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 116, "text": "1.Unscrew 4 screws, open electrical box and then remove electrical cover", "inverseText": "4.Close electrical box cover and then tighten four screws"}, 
						{"startFrame": 140, "stopFrame": 212, "text": "2.Loosen buckle and remove glass panel", "inverseText": "3.Install glass and tighten buckle"}, 
						{"startFrame": 236, "stopFrame": 308, "text": "3.Unscrew screws on bracket, remove bracket, and then remove lamp. Pay attention to cable.", "inverseText": "2.Mount lamp and bracket, and then tighten screws"}, 
						{"startFrame": 332, "stopFrame": 416, "text": "4.Unscrew screws and then remove ballast", "inverseText": "1.Install ballast and then tighten screws"}
					);
					break;
				case "ja_JP" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 116, "text": "1.四つのネジを緩めて、電器箱を開いて、電器箱カバーを取り外す。", "inverseText": "4.電器カバーに蓋をして、四つのネジを締める。"}, 
						{"startFrame": 140, "stopFrame": 212, "text": "2.ファスナーを開いて、ガラスパネルを取り外す。", "inverseText": "3.ガラスを取り付けて、ファスナーを押す。"}, 
						{"startFrame": 236, "stopFrame": 308, "text": "3.ブラケットネジを緩めて、ブラケットを取り外して、灯管を取り出す。電線を注意する。", "inverseText": "2.灯管のブラケットを取り付けて、ネジを締める。"}, 
						{"startFrame": 332, "stopFrame": 416, "text": "4.ネジを緩めて、バラストを取り出す。", "inverseText": "1.バラストを取り付けて、ネジを締める。"}
					);
					break;
				case "ko_KR" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 116, "text": "1.나사 네개를 빼내고 전함을 열리고 전함덮개를 떼다", "inverseText": "4.전함 덮개를 닫고 나사 네개를 조인다"}, 
						{"startFrame": 140, "stopFrame": 212, "text": "2.단춧구멍을 분해하고 유리패널을 뜯다", "inverseText": "3.유리를 설치하고 단춧구멍을 채우다"}, 
						{"startFrame": 236, "stopFrame": 308, "text": "3.스탠드 나사를 빼내고 스탠드를 분해하고 등관을 꺼내다,케이불 주의", "inverseText": "2.스탠드와 등관을 설치하고 나사를 조인다"}, 
						{"startFrame": 332, "stopFrame": 416, "text": "4.나사를 빼내고 안정기를 꺼내다", "inverseText": "1.안정기를 설치하고 나사를 조인다"}
					);
					break;
				case "fr_FR" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 116, "text": "1.Dévissez les quatre vis de fixation, ouvrez la boîte électrique, retirez le couvercle électrique", "inverseText": "4.Fermer le couvercle de la boîte électrique, visser les quatre vis"}, 
						{"startFrame": 140, "stopFrame": 212, "text": "2.Pressez sur le composant enfichable, enlevez le panneau de verre", "inverseText": "3.Installez le verre, presser fermement sur le composant enfichable"}, 
						{"startFrame": 236, "stopFrame": 308, "text": "3.Dévissez les vis de montage, enlevez le support,tirez la lampe, attention au câble", "inverseText": "2.Installez le support de lampe et serrez les vis"}, 
						{"startFrame": 332, "stopFrame": 416, "text": "4.Dévissez et enlevez le ballast", "inverseText": "1.Installez ballast, serrez les vis"}
					);
					break;
				case "ru_RU" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 116, "text": "1.Отверните 4 винта, откройте окно и снимите крышку электрического блока", "inverseText": "4.Покрывает крышку электрического блока, ввинтите 4 винта"}, 
						{"startFrame": 140, "stopFrame": 212, "text": "2.Снимите пряжку и панели стекла", "inverseText": "3.Установите стекло и пряжку"}, 
						{"startFrame": 236, "stopFrame": 308, "text": "3.Отверните винт кронштейна, снимите кронштейн и трубку, обратите внимание на кабель", "inverseText": "2.Установите кронштейн и трубку, ввинтите винт"}, 
						{"startFrame": 332, "stopFrame": 416, "text": "4.Отверните винт, принимает вне балласт", "inverseText": "1.Установите балласт, ввинтите винт"}
					);
					break;
				case "ar_SA" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 116, "text": "1فك المسامير الأربعة و فتح المربع الكهربائي، وإزالة الغطاء", "inverseText": "4تركيب غطاء المربع الكهربائي، وتشديد المسامير الأربعة"}, 
						{"startFrame": 140, "stopFrame": 212, "text": "2ضغط الرز وإزالة لوحة من الزجاج", "inverseText": "3تثبيت الزجاج مع تشديد الرز"}, 
						{"startFrame": 236, "stopFrame": 308, "text": "3فك مسامير الفرع  وإزالة الفرع  و  أخذ المصباح والانتباه إلى كابل", "inverseText": "2تثبيت فرع المصباح، و تشديد المسامير"}, 
						{"startFrame": 332, "stopFrame": 416, "text": "4فك المسمار وإزالة الكابح", "inverseText": "1تثبيت الكابح، وتشديد المسامير"}
					);
					break;
				case "es_ES" :
					textSequence.push(
						{"startFrame": 10, "stopFrame": 116, "text": "1.Retorcer 4 tornillos Abrir la caja eléctrica y retire la cubierta eléctrica.", "inverseText": "4.Cierre la tapa de la caja eléctrica,Apriete los tornillos"}, 
						{"startFrame": 140, "stopFrame": 212, "text": "2.Retire hebilla,baja el vidrio", "inverseText": "3.Instale vidrio, Monte hebilla"}, 
						{"startFrame": 236, "stopFrame": 308, "text": "3.Afloje los tornillos del soporte, Retire el soporte, retire la lámpara, atención a cable.", "inverseText": "2.Monte el soporte, Apriete los tornillos"}, 
						{"startFrame": 332, "stopFrame": 416, "text": "4.Afloje los tornillos,retire el balastro", "inverseText": "1.Instale balastro, Apriete los tornillos"}
					);
					break;
			}
		...
		private function initInstruction():void
		{
			switch (language)
			{
				case "zh_CN" :
					...
					instructionDict["bolimianban"] = "玻璃面板";//Glass panel
				...
				case "ru_RU" :
					...
					instructionDict["bolimianban"] = "панели стекла";
				...
				case "ar_SA" :
					...
					instructionDict["bolimianban"] = "لوحة زجاجية";
				...
				case "es_ES" :
					...
					instructionDict["bolimianban"] = "Vidrio";
