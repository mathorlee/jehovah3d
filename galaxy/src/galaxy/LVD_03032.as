package galaxy
{
	...
	public class LVD_03032 extends Scene3DTemplateForASProject
	{
...
//			trace("show: ", instruction);
		...
		private function initTextSequence():void
		{
			switch (language)
			{
				case "zh_CN" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 102, "text": "1.拧下4个螺丝", "inverseText": "8.拧上4个螺丝"}, 
						{"startFrame": 106, "stopFrame": 198, "text": "2.打开电箱，取下电箱盖", "inverseText": "7.盖上电箱盖"}, 
						{"startFrame": 202, "stopFrame": 270, "text": "3.拆下卡扣", "inverseText": "6.装上卡扣"}, 
						{"startFrame": 274, "stopFrame": 342, "text": "4.卸下玻璃面板", "inverseText": "5.安装玻璃面板"}, 
						{"startFrame": 346, "stopFrame": 414, "text": "5.拆卸支架", "inverseText": "4.安装支架"}, 
						{"startFrame": 418, "stopFrame": 486, "text": "6.拿出灯管", "inverseText": "3.装上灯管"}, 
						{"startFrame": 490, "stopFrame": 582, "text": "7.拧下螺丝", "inverseText": "2.拧上螺丝"}, 
						{"startFrame": 586, "stopFrame": 680, "text": "8.取出镇流器", "inverseText": "1.安装镇流器"}
					);
					break;
				case "en_US" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 102, "text": "1.Unscrew 4 screws", "inverseText": "8.Tighten four screws"}, 
						{"startFrame": 106, "stopFrame": 198, "text": "2.Open electrical box and then remove electrical cover", "inverseText": "7.Close electrical box cover"}, 
						{"startFrame": 202, "stopFrame": 270, "text": "3.Remove buckle", "inverseText": "6.Mount buckle"}, 
						{"startFrame": 274, "stopFrame": 342, "text": "4.Remove glass panel", "inverseText": "5.Install glass panel"}, 
						{"startFrame": 346, "stopFrame": 414, "text": "5.Remove bracket", "inverseText": "4.Mount bracket"}, 
						{"startFrame": 418, "stopFrame": 486, "text": "6.Remove lamp", "inverseText": "3.Mount lamp"}, 
						{"startFrame": 490, "stopFrame": 582, "text": "7.Unscrew screws", "inverseText": "2.Tighten screws"}, 
						{"startFrame": 586, "stopFrame": 680, "text": "8.Remove ballast", "inverseText": "1.Install ballast"}
					);
					break;
				case "ja_JP" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 102, "text": "1.四つのネジを緩める。", "inverseText": "8.四つのネジを締める。"}, 
						{"startFrame": 106, "stopFrame": 198, "text": "2.電器箱を開いて、電器箱カバーを取り外す。", "inverseText": "7.電器箱カバーにふたをする。"}, 
						{"startFrame": 202, "stopFrame": 270, "text": "3.ファスナーを取り外す。", "inverseText": "6.ファスナーを取り付ける。"}, 
						{"startFrame": 274, "stopFrame": 342, "text": "4.ガラスパネルを取り外す。", "inverseText": "5.ガラスパネルを取り付ける。"}, 
						{"startFrame": 346, "stopFrame": 414, "text": "5.ブラケットを取り外す。", "inverseText": "4.ブラケットを取付る。"}, 
						{"startFrame": 418, "stopFrame": 486, "text": "6.灯管を取り出す。", "inverseText": "3.灯管を取付る。"}, 
						{"startFrame": 490, "stopFrame": 582, "text": "7.ネジを緩める。", "inverseText": "2.ネジを締める。"}, 
						{"startFrame": 586, "stopFrame": 680, "text": "8.バラストを取り出す。", "inverseText": "1.バラストを取付る。"}
					);
					break;
				case "ko_KR" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 102, "text": "1.나사 네개를 빼내다", "inverseText": "8.나사 네개를 조인다"}, 
						{"startFrame": 106, "stopFrame": 198, "text": "2.전함을 열리고 전함덮개를 떼다", "inverseText": "7.전함 덮개를 닫다"}, 
						{"startFrame": 202, "stopFrame": 270, "text": "3.단춧구멍을 분해하다", "inverseText": "6.단춧구멍을 설치"}, 
						{"startFrame": 274, "stopFrame": 342, "text": "4.유리패널을 뜯다", "inverseText": "5.유리패널을 설치"}, 
						{"startFrame": 346, "stopFrame": 414, "text": "5.스탠드를 분해하다", "inverseText": "4.스탠드를 설치"}, 
						{"startFrame": 418, "stopFrame": 486, "text": "6.등관을 꺼내다", "inverseText": "3.등관을 설치"}, 
						{"startFrame": 490, "stopFrame": 582, "text": "7.나사를 빼내다", "inverseText": "2.나사를 조인다"}, 
						{"startFrame": 586, "stopFrame": 680, "text": "8.안정기를 꺼내다", "inverseText": "1.안정기를 설치"}
					);
					break;
				case "fr_FR" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 102, "text": "1.Dévissez les quatre vis", "inverseText": "8.Serrez les quatre vis"}, 
						{"startFrame": 106, "stopFrame": 198, "text": "2.Ouvrez la boîte électrique, retirez le couvercle électrique", "inverseText": "7.Fermer le couvercle de la boîte électrique"}, 
						{"startFrame": 202, "stopFrame": 270, "text": "3.Retirez le composant enfichable", "inverseText": "6.Installez le composant enfichable"}, 
						{"startFrame": 274, "stopFrame": 342, "text": "4.Retirez le panneau de verre", "inverseText": "5.Installez les panneaux de verre"}, 
						{"startFrame": 346, "stopFrame": 414, "text": "5.Retirez le support", "inverseText": "4.Montez le support"}, 
						{"startFrame": 418, "stopFrame": 486, "text": "6.Donnez l’ampoule", "inverseText": "3.Montez la lampe"}, 
						{"startFrame": 490, "stopFrame": 582, "text": "7.Retirez la vis", "inverseText": "2.Serrez les vis"}, 
						{"startFrame": 586, "stopFrame": 680, "text": "8.Retirez le ballast", "inverseText": "1.Installez ballast"}
					);
					break;
				case "ru_RU" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 102, "text": "1.Отверните 4 винта", "inverseText": "8.Ввинтите 4 винта"}, 
						{"startFrame": 106, "stopFrame": 198, "text": "2.Откройте окно и снимите крышку электрического блока", "inverseText": "7.Покрывает крышку электрического блока"}, 
						{"startFrame": 202, "stopFrame": 270, "text": "3.Снимите пряжку", "inverseText": "6.Установите пряжку"}, 
						{"startFrame": 274, "stopFrame": 342, "text": "4.Снимите панели стекла", "inverseText": "5.Установите панели стекла"}, 
						{"startFrame": 346, "stopFrame": 414, "text": "5.Снимите кронштейн", "inverseText": "4.Установите кронштейн"}, 
						{"startFrame": 418, "stopFrame": 486, "text": "6.Снимите трубку", "inverseText": "3.Установите трубку"}, 
						{"startFrame": 490, "stopFrame": 582, "text": "7.Отверните винт", "inverseText": "2.Ввинтите винт"}, 
						{"startFrame": 586, "stopFrame": 680, "text": "8.Принимает вне балласт", "inverseText": "1.Установите балласт"}
					);
					break;
				case "ar_SA" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 102, "text": " 1فك المسامير الأربعة", "inverseText": " 8تشديد المسامير الأربعة"}, 
						{"startFrame": 106, "stopFrame": 198, "text": "2فتح المربع الكهربائي، وإزالة الغطاء الكهربائي", "inverseText": " 7تثبيت غطاء المربع الكهربائي"}, 
						{"startFrame": 202, "stopFrame": 270, "text": "3إزالة الرز", "inverseText": "6تركيب الرز"}, 
						{"startFrame": 274, "stopFrame": 342, "text": "4إزالة لوحة من الزجاج", "inverseText": "5تثبيت الألواح الزجاجية"}, 
						{"startFrame": 346, "stopFrame": 414, "text": " 5إزالة الفرع", "inverseText": " 4تثبيت فرع المصباح"}, 
						{"startFrame": 418, "stopFrame": 486, "text": " 6أخذ أنبوبة المصباح", "inverseText": "3تركيب انبوبة المصباح"}, 
						{"startFrame": 490, "stopFrame": 582, "text": "7إزالة المسمار", "inverseText": "2تشديد المسامير"}, 
						{"startFrame": 586, "stopFrame": 680, "text": "8إزالة الكابح", "inverseText": " 1تثبيت الكابح"}
					);
					break;
				case "es_ES" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 102, "text": "1.Retorcer 4 tornillos", "inverseText": "8.Apriete los tornillos"}, 
						{"startFrame": 106, "stopFrame": 198, "text": "2.Abrir la caja eléctrica y retire la cubierta eléctrica", "inverseText": "7.Cierre la tapa de la caja eléctrica"}, 
						{"startFrame": 202, "stopFrame": 270, "text": "3.Retire hebilla", "inverseText": "6.Monte hebilla"}, 
						{"startFrame": 274, "stopFrame": 342, "text": "4.Baja el vidrio", "inverseText": "5.Instale vidrio"}, 
						{"startFrame": 346, "stopFrame": 414, "text": "5.Retire el soporte", "inverseText": "4.Monte el soporte"}, 
						{"startFrame": 418, "stopFrame": 486, "text": "6.Retire la lámpara", "inverseText": "3.Imstale la lámpara"}, 
						{"startFrame": 490, "stopFrame": 582, "text": "7.Afloje los tornillos", "inverseText": "2.Apriete los tornillos"}, 
						{"startFrame": 586, "stopFrame": 680, "text": "8.Retire el balastro", "inverseText": "1.Instale balastro"}
					);
					break;
			}
			totalAnimationFrame = 680;
