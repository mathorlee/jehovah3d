package galaxy
{
	...
	public class Galaxy extends Scene3DTemplateForASProject
	{
		...
		private var init_scale:Number = 1.0;
		...
		private function getURLParameter():void
		{
			...
			{
				if(loaderInfo.parameters.id)
					id = loaderInfo.parameters.id;
				if(loaderInfo.parameters.init_scale)
					init_scale = Number(loaderInfo.parameters.init_scale);
				if(init_scale > maxScale || init_scale < minScale)
					init_scale = 1.0;
				trace(id, init_scale);
			}
		}
