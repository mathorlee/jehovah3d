package galaxy
{
	...
	public class Galaxy_LocalAssets extends Scene3DTemplateForASProject
	{
		private const BACKGROUN_COLOR:uint = 0xFFFFFF;
		private const RULER_COLOR:uint = 0x333333;
		
		private var baseURL:String = "static/flash/3dshow/";
		...
		public function Galaxy_LocalAssets()
		{
			getURLParameter();
			super();
		}
		...
		override public function initScene():void
		{
			...
			var recordRequest:URLRequest = new URLRequest(baseURL + "setting.txt");
