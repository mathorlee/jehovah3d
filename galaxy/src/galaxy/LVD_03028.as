package galaxy
{
	...
	public class LVD_03028 extends Scene3DTemplateForASProject
	{
...
//			trace("show: ", instruction);
		...
		private function initTextSequence():void
		{
			switch (language)
			{
				case "zh_CN" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 60, "text": "1.拧下电箱侧盖螺丝，取下2侧盖", "inverseText": "4.盖上电箱盖，拧上螺丝"}, 
						{"startFrame": 84, "stopFrame": 254, "text": "2.拆下卡扣，拧下螺丝，松开抱箍，卸掉抱箍，卸下密封条、玻璃", "inverseText": "3.安装玻璃，封条，抱箍，拧上螺丝"}, 
						{"startFrame": 282, "stopFrame": 354, "text": "3.拧下支架螺丝，拆卸支架，拿出灯管，注意电线", "inverseText": "2.安装灯管支架，拧上螺丝"}, 
						{"startFrame": 382, "stopFrame": 478, "text": "4.拧下镇流器侧边螺丝,抽出镇流器", "inverseText": "1.安装镇流器，拧上螺丝"}
					);
					break;
				case "en_US" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 60, "text": "1.Unscrew 4 screws, open electrical box and then remove electrical cover", "inverseText": "4.Close electrical box cover, tighten four screws"}, 
						{"startFrame": 84, "stopFrame": 254, "text": "2.Unscrew screws, loosen and remove hoop, remove sealing strip, remove glass", "inverseText": "3.Install glass, sealing strip and hoop, tighten screws"}, 
						{"startFrame": 282, "stopFrame": 354, "text": "3.Unscrew screws on bracket, Remove bracket and then remove lamp. Pay attention to cable.", "inverseText": "2.Mount bracket and lamp, tighten screws on bracket"}, 
						{"startFrame": 382, "stopFrame": 478, "text": "4.Unscrew screws, remove ballast", "inverseText": "1.Install ballast, tighten screws"}
					);
					break;
				case "ja_JP" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 60, "text": "1.四つのネジを緩める,電器箱を開いて、電器箱カバーを取り外す", "inverseText": "4.電器カバーにふたをする,四つのネジを締める"}, 
						{"startFrame": 84, "stopFrame": 254, "text": "2.ネジを緩める,ファスナーを開いて、ファスナーを取り外す,シーリングストリップを取り外す,ガラスを取り外す", "inverseText": "3.ガラスを取付る,シーリングストリップを取付る,ファスナーを取付る,ネジを締める"}, 
						{"startFrame": 282, "stopFrame": 354, "text": "3.ブラケットネジを緩める,ブラケットを解体して灯管と分離する。電線を注意する", "inverseText": "2.ブラケットと灯管を取付る,灯管のネジを締める"}, 
						{"startFrame": 382, "stopFrame": 478, "text": "4.ネジを緩める,バラストを取り出す", "inverseText": "1.バラストを取付る,ネジを締める"}
					);
					break;
				case "ko_KR" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 60, "text": "1.나사 네개를 빼내다,전함을 열리고 전함덮개를 떼다", "inverseText": "4.전함 덮개를 닫다,나사 네개를 조인다"}, 
						{"startFrame": 84, "stopFrame": 254, "text": "2.나사를 빼내다,조임테를 풀어지고 조임테를 뜯다,웨더스트립을 뜯다,유리를 뜯다", "inverseText": "3.유리를 설치,웨더스트립을 설치,조임테를 설치,나사를 조인다"}, 
						{"startFrame": 282, "stopFrame": 354, "text": "3.스탠드 나사를 빼내다,스탠드를 분해하여 등관을 꺼내다,케이불 주의", "inverseText": "2.스탠드와 등관을 설치,스탠드 나사를 조인다"}, 
						{"startFrame": 382, "stopFrame": 478, "text": "4.나사를 빼내다,안정기를 꺼내다", "inverseText": "1.안정기를 설치,나사를 조인다"}
					);
					break;
				case "fr_FR" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 60, "text": "1.Dévissez les quatre vis, ouvrez la boîte électrique, retirez le couvercle électrique", "inverseText": "4.Fermer le couvercle de la boîte électrique, serrer les quatre vis"}, 
						{"startFrame": 84, "stopFrame": 254, "text": "2.Retirez la vis, desserrez et déchargezle cerceau, retirez le joint, retirez le verre", "inverseText": "3.Installer le cerveau, serrer les vis"}, 
						{"startFrame": 282, "stopFrame": 354, "text": "3.Dévissez les vis du support, retirez le support de la lampe, faites attention au câble", "inverseText": "2.Installer le support de fixation et la lampe, serrer les vis sur le support, installer le verre, installer le joint"}, 
						{"startFrame": 382, "stopFrame": 478, "text": "4.Retirez la vis, retirez le ballast", "inverseText": "1.Installer le ballast, serrer les vis"}
					);
					break;
				case "ru_RU" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 60, "text": "1.Отверните 4 винта, oткройте окно и снимите крышку электрического блока", "inverseText": "4.Покрывает крышку электрического блока, ввинтите 4 винта"}, 
						{"startFrame": 84, "stopFrame": 254, "text": "2.Отверните винт, снимите обруч, cнимите запечатанный прут, cнимите стекло", "inverseText": "3.Установите обруч, ввинтите винт"}, 
						{"startFrame": 282, "stopFrame": 354, "text": "3.Отверните винты кронштейна, cнимите кронштейн и трубку，обратите внимание на кабель", "inverseText": "2.Установите кронштейн и трубку, ввинтите винты кронштейна, yстановите стекло, yстановите запечатанный прут"}, 
						{"startFrame": 382, "stopFrame": 478, "text": "4.Отверните винт, иринимает вне балласт", "inverseText": "1.Установите балласт, ввинтите винт"}
					);
					break;
				case "ar_SA" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 60, "text": "1فك المسامير الأربعةفتح المربع الكهربائي، وإزالة الغطاء الكهربائي", "inverseText": " 4تركيب غطاء الصندوق الكهربائيتشديد المسامير الأربع"}, 
						{"startFrame": 84, "stopFrame": 254, "text": "2إزالة المسمارقم بفك جهاز مطوق، ازال مطوق إزالة الختم إزالة الزجاج", "inverseText": " 3تركيب جهاز مطوق تشديد مسامير"}, 
						{"startFrame": 282, "stopFrame": 354, "text": " 3فك مسامير الفرعإزالة الفرع لأخذ المصباح، مع الانتباه إلى كابل", "inverseText": " 2تركيب فرع و انبوبة المصباحتشديد مسامير الفرعتثبيت الزجاج تثبيت الختم"}, 
						{"startFrame": 382, "stopFrame": 478, "text": "4إزالة المسمارإزالة الكابح", "inverseText": " 1تثبيت الكابح تشديد مسامير"}
					);
					break;
				case "es_ES" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 60, "text": "1.Retorcer 4 tornillos, abrir la caja eléctrica y retire la cubierta eléctrica", "inverseText": "4.Cierre la tapa de la caja eléctrica, apriete los cuatro tornillos"}, 
						{"startFrame": 84, "stopFrame": 254, "text": "2.Afloje los tornillos, afloje y retire el aro, retire la tira de sellado, baja el vidrio", "inverseText": "3.Instale el aro, apriete los tornillos"}, 
						{"startFrame": 282, "stopFrame": 354, "text": "3.Afloje los tornillos de soporte, retire el soporte y retire la lámpara. atención a cable", "inverseText": "2.Monte el soporte y la lámpara, apriete los tornillos en el soporte, instale vidrio, instale la tira de sellado"}, 
						{"startFrame": 382, "stopFrame": 478, "text": "4.Afloje los tornillos, retire el balastro", "inverseText": "1.Instale balastro, apriete los tornillos"}
					);
					break;
			}
		...
		private function initInstruction():void
		{
			switch (language)
			{
				...
				case "en_US" :
					...
					instructionDict["cegai2"] = "Side cover";
				...
				case "fr_FR" :
					...
					instructionDict["cegai2"] = "couvercle latéral";
				...
				case "ar_SA" :
					...
					instructionDict["cegai2"] = "الغطاء الجانبي";
				...
				case "es_ES" :
					...
					instructionDict["cegai2"] = "Cubierta lateral";
