package editor.view
{
	...
	public class Scene3DTemplateForFlexProject extends UIComponent
	{
		public var scene:Object3D;
		public var stage3D:Stage3D;
		public var camera:Camera3D;
		
		public function Scene3DTemplateForFlexProject()
		{
			if(stage)
				onAdded();
			else
		...
		private function handleContextLoss(evt:Event):void
		{
			...
			/*
			http://helpx.adobe.com/flash-player/kb/stage3d-known-issues-flash-player.html
