package jehovah3d.core.renderer
{
	...
	public class DSRendererFreeLight extends Renderer
	{
		...
		override public function collectResource():void
		{
			...
			MyMath.mergeTwoArray(vertexConstants, MyMath.matrix3DToProgram3DConstants(localToLight), true);
			assetsDict[C_PROJECTION_MATRIX] = currentVC(); //灯光的投影矩阵
			MyMath.mergeTwoArray(vertexConstants, MyMath.matrix3DToProgram3DConstants(freeLight.projectionMatrix), true);
			...
			MyMath.mergeTwoArray(fragmentConstants, CVVUVToScreenUVMatrix(), true);
