package panorama
{
	...
	public class SpherePanorama3DShow extends Sprite
	{
		...
		private var showPurchaseButton:Boolean = false;
		
		public function SpherePanorama3DShow()
		{
			initTriangles();
			getURLParameter();
			onAdded();
...
//				trace(v_arr[i0][0], v_arr[i0][1], v_arr[i0][2], uv_arr[uv0][0], uv_arr[uv0][1]);
//				trace(v_arr[i1][0], v_arr[i1][1], v_arr[i1][2], uv_arr[uv1][0], uv_arr[uv1][1]);
//				trace(v_arr[i2][0], v_arr[i2][1], v_arr[i2][2], uv_arr[uv2][0], uv_arr[uv2][1]);
//				trace();
			}
		}
		private function getURLParameter():void
		{
			...
			var id:String = obj.hasOwnProperty("id") ? obj.id : "e889f8a86c8adcbe782b53a005fab087";
			var file_name:String = obj.hasOwnProperty("file_name") ? obj.file_name : "origin";
			showPurchaseButton = obj.hasOwnProperty("show_purchase") ? Boolean(int(obj.show_purchase)) : false;
			imageURL = "http://3dshow.flash.jaeapp.com/view/file/getfile.php?folder=" + id + "&name=" + file_name + ".jpg";
