package panorama
{
	...
	public class EmbedResourceSpherePanorama3DShowPlayLoading extends Sprite
	{
		...
		[Embed(source="/panorama/assets/sphere/sphere5.jpg", mimeType="image/jpeg")]
		...
		public function EmbedResourceSpherePanorama3DShowPlayLoading()
		{
			onAdded();
		}
...
//			canvas.graphics.lineStyle(1, 0x000000, 1);
		...
		[Embed(source="/panorama/assets/images/newui2/brandlogo-normal.png", mimeType="image/png")]
		private var brand_logo_default:Class;
		
		[Embed(source="/panorama/assets/images/newui2/bg-normal.jpg", mimeType="image/jpeg")]
