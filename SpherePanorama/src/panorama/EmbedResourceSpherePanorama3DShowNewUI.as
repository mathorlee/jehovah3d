package panorama
{
	...
	public class EmbedResourceSpherePanorama3DShowNewUI extends Sprite
	{
		 ...
		 * 电视视频地址 
		 */		
//		public var flvUrl:String = "/panorama/assets/sphere/test.flv";
		public var flvUrl:String = "file:///E:/hg_model/SpherePanorama/src/panorama/assets/sphere/test.flv";
		//视频容器 
...
//		private var initRotationY:Number = -0.3298353984802599;
		...
		public function EmbedResourceSpherePanorama3DShowNewUI()
		{
			onAdded();
		}
...
//			initFlv();
		...
		private function initFlvScence():void
		{
			if(tvPoints==null)
			{
				...
				tvPoints.push(new Point(4030,1460));
				tvPoints.push(new Point(3720,1470));
				tvPoints.push(new Point(3718,1654));
				tvPoints.push(new Point(4028,1697));
			}
...
//			canvas.graphics.lineStyle(1, 0x000000, 1);
			...
			if(flvCanvas!=null&&this.flvBitmapData!=null)
			{
				flvCanvas.graphics.clear();
//				flvCanvas.graphics.lineStyle(1, 0x000000, 1);
