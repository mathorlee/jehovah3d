package jehovah3d.core.renderer
{
	...
	public class Renderer
	{
		...
		public function texParameter(dimension:String):String
		{
			...
			if (mesh.useClamp || dimension == "cube")
				ret += "clamp>";
			else
				ret += "repeat>";
		...
		*/
		...
		//常用常数
		public static const C_HALP:String = "Half";
		...
		public static const C_WIREFRAME_DEPTH_OFFSET:String = "WireFrameDepthOffset"; //wireframe易被面覆盖。将其CVV的z提高一些。
