package galaxy
{
	...
	public class LVD_03022 extends Scene3DTemplateForASProject
	{
...
//			trace("show: ", instruction);
		...
		private function initTextSequence():void
		{
			switch (language)
			{
				...
				case "en_US" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 98, "text": "1.Unscrew 4 screws", "inverseText": "10.Tighten four screws"}, 
						{"startFrame": 100, "stopFrame": 182, "text": "2.Open electrical box and then remove electrical cover", "inverseText": "9.Close electrical box cover"}, 
						{"startFrame": 184, "stopFrame": 248, "text": "3.Unscrew screws", "inverseText": "8.Tighten screws"}, 
						{"startFrame": 250, "stopFrame": 320, "text": "4.Loosen and remove hoop", "inverseText": "7.Install hoop"}, 
						{"startFrame": 323, "stopFrame": 397, "text": "5.Remove sealing strip", "inverseText": "6.Install sealing strip"}, 
						{"startFrame": 400, "stopFrame": 470, "text": "6.Remove glass", "inverseText": "5.Install glass"}, 
						{"startFrame": 472, "stopFrame": 542, "text": "7.Unscrew screws on bracket", "inverseText": "4.Tighten screws on bracket"}, 
						{"startFrame": 544, "stopFrame": 613, "text": "8.Remove bracket and then remove lamp. Pay attention to cable.", "inverseText": "3.Mount bracket and lamp"}, 
						{"startFrame": 616, "stopFrame": 710, "text": "9.Unscrew screws", "inverseText": "2.Tighten screws"}, 
						{"startFrame": 712, "stopFrame": 770, "text": "10.Remove ballast", "inverseText": "1.Install ballast"}
					);
					break;
				case "ja_JP" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 98, "text": "1.四つのネジを緩める。", "inverseText": "10.四つのネジを締める。"}, 
						{"startFrame": 100, "stopFrame": 182, "text": "2.電器箱を開いて、電器箱カバーを取り外す。", "inverseText": "9.電器カバーにふたをする。"}, 
						{"startFrame": 184, "stopFrame": 248, "text": "3.ネジを緩める。", "inverseText": "8.ネジを締める。"}, 
						{"startFrame": 250, "stopFrame": 320, "text": "4.ファスナーを開いて、ファスナーを取り外す。", "inverseText": "7.ファスナーを取付る。"}, 
						{"startFrame": 323, "stopFrame": 397, "text": "5.シーリングストリップを取り外す。", "inverseText": "6.シーリングストリップを取付る。"}, 
						{"startFrame": 400, "stopFrame": 470, "text": "6.ガラスを取り外す。", "inverseText": "5.ガラスを取付る。"}, 
						{"startFrame": 472, "stopFrame": 542, "text": "7.ブラケットネジを緩める。", "inverseText": "4.灯管のネジを締める。"}, 
						{"startFrame": 544, "stopFrame": 613, "text": "8.ブラケットを解体して灯管と分離する。電線を注意する。", "inverseText": "3.ブラケットと灯管を取付る。"}, 
						{"startFrame": 616, "stopFrame": 710, "text": "9.ネジを緩める。", "inverseText": "2.ネジを締める。"}, 
						{"startFrame": 712, "stopFrame": 770, "text": "10.バラストを取り出す。", "inverseText": "1.バラストを取付る。"}
					);
					break;
				case "ko_KR" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 98, "text": "1.나사 네개를 빼내다", "inverseText": "10.나사 네개를 조인다"}, 
						{"startFrame": 100, "stopFrame": 182, "text": "2.전함을 열리고 전함덮개를 떼다", "inverseText": "9.전함 덮개를 닫다"}, 
						{"startFrame": 184, "stopFrame": 248, "text": "3.나사를 빼내다", "inverseText": "8.나사를 조인다"}, 
						{"startFrame": 250, "stopFrame": 320, "text": "4.조임테를 풀어지고 조임테를 뜯다", "inverseText": "7.조임테를 설치"}, 
						{"startFrame": 323, "stopFrame": 397, "text": "5.웨더스트립을 뜯다", "inverseText": "6.웨더스트립을 설치"}, 
						{"startFrame": 400, "stopFrame": 470, "text": "6.유리를 뜯다", "inverseText": "5.유리를 설치"}, 
						{"startFrame": 472, "stopFrame": 542, "text": "7.스탠드 나사를 빼내다", "inverseText": "4.스탠드 나사를 조인다"}, 
						{"startFrame": 544, "stopFrame": 613, "text": "8.스탠드를 분해하여 등관을 꺼내다,케이불 주의", "inverseText": "3.스탠드와 등관을 설치"}, 
						{"startFrame": 616, "stopFrame": 710, "text": "9.나사를 빼내다", "inverseText": "2.나사를 조인다"}, 
						{"startFrame": 712, "stopFrame": 770, "text": "10.안정기를 꺼내다", "inverseText": "1.안정기를 설치"}
					);
					break;
				case "fr_FR" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 98, "text": "1.Dévissez les quatre vis ", "inverseText": "10.Serrer les quatre vis"}, 
						{"startFrame": 100, "stopFrame": 182, "text": "2.Ouvrez la boîte électrique, retirez le couvercle électrique", "inverseText": "9.Fermer le couvercle de la boîte électrique"}, 
						{"startFrame": 184, "stopFrame": 248, "text": "3.Retirez la vis", "inverseText": "8.Serrer les vis"}, 
						{"startFrame": 250, "stopFrame": 320, "text": "4.Desserrez et déchargezle cerceau", "inverseText": "7.Installer le cerveau"}, 
						{"startFrame": 323, "stopFrame": 397, "text": "5.Retirez le joint", "inverseText": "6.Installer le joint"}, 
						{"startFrame": 400, "stopFrame": 470, "text": "6.Retirez le verre", "inverseText": "5.Installer le verre"}, 
						{"startFrame": 472, "stopFrame": 542, "text": "7.Dévissez les vis du support", "inverseText": "4.Serrer les vis sur le support"}, 
						{"startFrame": 544, "stopFrame": 613, "text": "8.Retirez le support de la lampe, faites attention au câble", "inverseText": "3.Installer le support de fixation et la lampe"}, 
						{"startFrame": 616, "stopFrame": 710, "text": "9.Retirez la vis", "inverseText": "2.Serrer les vis "}, 
						{"startFrame": 712, "stopFrame": 770, "text": "10.Retirez le ballast", "inverseText": "1.Installer le ballast"}
					);
					break;
				case "ru_RU" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 98, "text": "1.Отверните 4 винта", "inverseText": "10.Ввинтите 4 винта"}, 
						{"startFrame": 100, "stopFrame": 182, "text": "2.Откройте окно и снимите крышку электрического блока", "inverseText": "9.Покрывает крышку электрического блока"}, 
						{"startFrame": 184, "stopFrame": 248, "text": "3.Отверните винт", "inverseText": "8.Ввинтите винт"}, 
						{"startFrame": 250, "stopFrame": 320, "text": "4.Снимите обруч", "inverseText": "7.Установите обруч"}, 
						{"startFrame": 323, "stopFrame": 397, "text": "5.Снимите запечатанный прут", "inverseText": "6.Установите запечатанный прут"}, 
						{"startFrame": 400, "stopFrame": 470, "text": "6.Снимите стекло", "inverseText": "5.Установите стекло"}, 
						{"startFrame": 472, "stopFrame": 542, "text": "7.Отверните винты кронштейна", "inverseText": "4.Ввинтите винты кронштейна"}, 
						{"startFrame": 544, "stopFrame": 613, "text": "8.Снимите кронштейн и трубку，обратите внимание на кабель", "inverseText": "3.Установите кронштейн и трубку"}, 
						{"startFrame": 616, "stopFrame": 710, "text": "9.Отверните винт", "inverseText": "2.Ввинтите винт"}, 
						{"startFrame": 712, "stopFrame": 770, "text": "10.Принимает вне балласт", "inverseText": "1.Установите балласт"}
					);
					break;
				case "ar_SA" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 98, "text": " 1فك المسامير الأربعة", "inverseText": "10تشديد المسامير الأربع"}, 
						{"startFrame": 100, "stopFrame": 182, "text": "2فتح المربع الكهربائي، وإزالة الغطاء الكهربائي", "inverseText": "9تركيب غطاء الصندوق الكهربائي"}, 
						{"startFrame": 184, "stopFrame": 248, "text": "3إزالة المسمار", "inverseText": " 8تشديد مسامير"}, 
						{"startFrame": 250, "stopFrame": 320, "text": " 4قم بفك جهاز مطوق، ازال مطوق", "inverseText": " 7تركيب جهاز مطوق"}, 
						{"startFrame": 323, "stopFrame": 397, "text": "5إزالة الختم", "inverseText": "6تثبيت الختم"}, 
						{"startFrame": 400, "stopFrame": 470, "text": " 6إزالة الزجاج", "inverseText": " 5تثبيت الزجاج"}, 
						{"startFrame": 472, "stopFrame": 542, "text": "7فك مسامير الفرع", "inverseText": " 4تشديد مسامير الفرع"}, 
						{"startFrame": 544, "stopFrame": 613, "text": " 8إزالة الفرع لأخذ المصباح، مع الانتباه إلى كابل", "inverseText": " 3تركيب فرع و انبوبة المصباح"}, 
						{"startFrame": 616, "stopFrame": 710, "text": "9إزالة المسمار", "inverseText": " 2تشديد مسامير"}, 
						{"startFrame": 712, "stopFrame": 770, "text": "10إزالة الكابح", "inverseText": " 1تثبيت الكابح"}
					);
					break;
				case "es_ES" :
					textSequence.push(
						{"startFrame": 0, "stopFrame": 98, "text": "1.Retorcer 4 tornillos", "inverseText": "10.Apriete los cuatro tornillos"}, 
						{"startFrame": 100, "stopFrame": 182, "text": "2.Abrir la caja eléctrica y retire la cubierta eléctrica", "inverseText": "9.Cierre la tapa de la caja eléctrica"}, 
						{"startFrame": 184, "stopFrame": 248, "text": "3.Afloje los tornillos", "inverseText": "8.Apriete los tornillos"}, 
						{"startFrame": 250, "stopFrame": 320, "text": "4.Afloje y retire el aro", "inverseText": "7.Instale el aro"}, 
						{"startFrame": 323, "stopFrame": 397, "text": "5.Retire la tira de sellado", "inverseText": "6.Instale la tira de sellado"}, 
						{"startFrame": 400, "stopFrame": 470, "text": "6.baja el vidrio", "inverseText": "5.Instale vidrio"}, 
						{"startFrame": 472, "stopFrame": 542, "text": "7.Afloje los tornillos de soporte", "inverseText": "4.Apriete los tornillos en el soporte"}, 
						{"startFrame": 544, "stopFrame": 613, "text": "8.Retire el soporte y retire la lámpara. atención a cable", "inverseText": "3.Monte el soporte y la lámpara"}, 
						{"startFrame": 616, "stopFrame": 710, "text": "9.Afloje los tornillos", "inverseText": "2.Apriete los tornillos"}, 
						{"startFrame": 712, "stopFrame": 770, "text": "10.retire el balastro", "inverseText": "1.Instale balastro"}
					);
					break;
			}
		...
		private function initInstruction():void
		{
			switch (language)
			{
				case "zh_CN" :
					...
					break;
				case "en_US" :
					instructionDict["baogu"] = "Hoop";
					instructionDict["boli"] = "Toughened glass";
					instructionDict["dengjia"] = "Bracket";
					instructionDict["dengpao"] = "LVD induction lamp";
					instructionDict["dengzao"] = "Shade";
					instructionDict["dianqixiang1"] = "Electrical box";
					instructionDict["dianqixiang2"] = "Electrical box";
					instructionDict["piquan"] = "Apron";
					instructionDict["tiesiwang"] = "Barbed wire";
					instructionDict["zhenliuqi"] = "Ballast";
					break;
				case "ja_JP" :
					instructionDict["baogu"] = "フープ";
					instructionDict["boli"] = "硬化ガラス";
					instructionDict["dengjia"] = "スタンド";
					instructionDict["dengpao"] = "LVD無電極ランプ";
					instructionDict["dengzao"] = "ランプカバー";
					instructionDict["dianqixiang1"] = "電器箱";
					instructionDict["dianqixiang2"] = "電器箱";
					instructionDict["piquan"] = "ゴム";
					instructionDict["tiesiwang"] = "鉄線の網";
					instructionDict["zhenliuqi"] = "バラスト";
					break;
				case "ko_KR" :
					instructionDict["baogu"] = "조임테";
					instructionDict["boli"] = "강화유리";
					instructionDict["dengjia"] = "스탠드";
					instructionDict["dengpao"] = "LVD무전극 램프";
					instructionDict["dengzao"] = "등갓";
					instructionDict["dianqixiang1"] = "전함";
					instructionDict["dianqixiang2"] = "전함";
					instructionDict["piquan"] = "고무 튜브";
					instructionDict["tiesiwang"] = "철조망";
					instructionDict["zhenliuqi"] = "안정기";
					break;
				case "fr_FR" :
					instructionDict["baogu"] = "Cercle";
					instructionDict["boli"] = "Verre en acier";
					instructionDict["dengjia"] = "Support";
					instructionDict["dengpao"] = " LVD lampe à induction";
					instructionDict["dengzao"] = "Abat-jour";
					instructionDict["dianqixiang1"] = "Boîte électrique";
					instructionDict["dianqixiang2"] = "Boîte électrique";
					instructionDict["piquan"] = "Tablier";
					instructionDict["tiesiwang"] = "fil de fer barbelé";
					instructionDict["zhenliuqi"] = "Ballast";
					break;
				case "ru_RU" :
					instructionDict["baogu"] = "обруч";
					instructionDict["boli"] = "закаленное стекло";
					instructionDict["dengjia"] = "кронштейн";
					instructionDict["dengpao"] = "LVD индукционные лампы";
					instructionDict["dengzao"] = "абажура";
					instructionDict["dianqixiang1"] = "электрический блок";
					instructionDict["dianqixiang2"] = "электрический блок";
					instructionDict["piquan"] = "ремешок";
					instructionDict["tiesiwang"] = "колючая проволока";
					instructionDict["zhenliuqi"] = "балласт";
					break;
				case "ar_SA" :
					instructionDict["baogu"] = "طارة";
					instructionDict["boli"] = "الزجاج الصلبي";
					instructionDict["dengjia"] = "الإطار";
					instructionDict["dengpao"] = "LVD مصباح";
					instructionDict["dengzao"] = "الظل";
					instructionDict["dianqixiang1"] = "المربع الكهربائي";
					instructionDict["dianqixiang2"] = "المربع الكهربائي";
					instructionDict["piquan"] = "مآزر";
					instructionDict["tiesiwang"] = "شبكة حديدية";
					instructionDict["zhenliuqi"] = "الكوابح";
					break;
				case "es_ES" :
					instructionDict["baogu"] = "aro";
					instructionDict["boli"] = "el vidrio templado";
					instructionDict["dengjia"] = "el soporte";
					instructionDict["dengpao"] = "lámpara LVD inducción";
					instructionDict["dengzao"] = "la pantalla";
					instructionDict["dianqixiang1"] = "la caja eléctrica";
					instructionDict["dianqixiang2"] = "la caja eléctrica";
					instructionDict["piquan"] = "la goma";
					instructionDict["tiesiwang"] = "alambre de púas";
