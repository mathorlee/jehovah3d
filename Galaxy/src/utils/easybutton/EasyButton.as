package utils.easybutton
{
	...
	public class EasyButton extends Sprite
	{
		...
		private function addLabel():void
		{
			...
			l.width = WIDTH;
			l.text = _label;
			if(l.textWidth>WIDTH)
			{
				l.width = l.textWidth+20;
				offsetX = (l.width-WIDTH)/2;
				_upState.x+=offsetX;
			}
			...
			l.setTextFormat(new TextFormat("Arial", 12, 0xFFFFFF, null, null, null, null, null, TextFormatAlign.CENTER));
			l.y = 38;
			this.addChild(l);
		}
