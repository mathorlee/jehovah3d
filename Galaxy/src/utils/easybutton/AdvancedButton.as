package utils.easybutton
{
	...
	public class AdvancedButton extends Sprite
	{
		...
		public function AdvancedButton(upState:DisplayObject, overState:DisplayObject, downState:DisplayObject)
		{
			_upState = upState;
		...
		{
			_upState.visible = (_state == EasyButtonState.UP_STATE);
			_overState.visible = (_state == EasyButtonState.OVER_STATE);
			_downState.visible = (_state == EasyButtonState.DOWN_STATE);
